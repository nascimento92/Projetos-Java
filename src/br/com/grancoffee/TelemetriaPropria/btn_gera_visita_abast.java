...
public class btn_gera_visita_abast implements AcaoRotinaJava{
	 ...
	 * private void lista() {
	 * 
	 * int verificaQuantidade = 0; String patrimonio = null;
	 * 
	 * do { verificaQuantidade = verificaQuantidade(); patrimonio =
	 * verificaPrimeiraMaquinaParaGerar();
	 * 
	 * if(patrimonio!=null) { gerarPedidoENota(patrimonio); }
	 * 
	...
	/*
	 * private DynamicVO getGCSOLICITABAST(String patrimonio) throws Exception {
	 * JapeWrapper DAO = JapeFactory.dao("GCSolicitacoesAbastecimento"); DynamicVO
	 * VO = DAO.findOne("CODGRUPOPROD=?", new Object[] { grupo }); return VO; }
	 */
	...
	private BigDecimal geraCabecalho(String patrimonio, DynamicVO gc_solicitabast) throws Exception {
		  ...
		  try { 
			  ...
			  BigDecimal nuNotaModelo = new BigDecimal(134966926);
				  ...
				  NotaProdVO.setProperty("CODUSU", "N");
