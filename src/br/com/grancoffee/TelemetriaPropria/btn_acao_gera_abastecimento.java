...
public class btn_acao_gera_abastecimento implements AcaoRotinaJava{
	...
	private void getListaPendente() throws Exception {
		...
		Collection<?> parceiro = dwfEntityFacade
				.findByDynamicFinder(new FinderWrapper("GCSolicitacoesAbastecimento", "this.STATUS=? AND this.REABASTECIMENTO=? AND this.NUMOS IS NULL AND DTAGENDAMENTO <= SYSDATE AND ROWNUM <= 5", new Object[] { "1","S" }));
